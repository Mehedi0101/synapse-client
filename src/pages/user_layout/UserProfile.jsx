    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-8 text-semi-dark mx-2 md:mx-5 my-8 text-sm lg:text-base min-w-0">
                    ...
                    <div className="mt-5 space-y-2">
                        ...
                        <div className="mt-6 space-y-2">
                            ...
                            {/* ---------- LinkedIn ---------- */}
                            {
                                ...
                                <p className="flex items-center gap-2"><FaLinkedinIn className="text-lg" /> <a className="hover:text-primary hover:underline active:text-primary active:underline truncate font-semibold" href="https://www.linkedin.com/in/mehedi0101/" target="_blank">https://www.linkedin.com/in/mehedi0101/</a></p>
                            }

                            {/* ---------- GitHub ---------- */}
                            {
                                userDetails?.github &&
                                <p className="flex items-center gap-2"><FiGithub className="text-lg" /> <a className="hover:text-primary hover:underline active:text-primary active:underline truncate font-semibold" href="https://github.com/Mehedi0101" target="_blank">Mehedi0101</a></p>
                            }
                ...
                {/* ---------- Right Grid Section ---------- */}
                <div className="col-span-1 sm:col-span-7 lg:col-span-8">
