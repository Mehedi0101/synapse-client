const ButtonWide = ({ text, className='', ...props }) => {
  return (
    <button className={`group relative w-full rounded-full px-4 py-2.5 text-white font-medium focus:outline-none transition-all ease-linear cursor-pointer overflow-hidden ${className}`} {...props}>
