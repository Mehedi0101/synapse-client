...
const EventCard = ({ event, isMyEvent = false }) => {
    ...
    return (
        <Link to={`/events/${event?._id}`} className="rounded-xl flex flex-col shadow-lg hover:shadow-xl cursor-pointer">
            {/* ---------- Banner ---------- */}
            <div
                className="h-40 bg-cover bg-no-repeat bg-center rounded-t-xl"
                style={{
            ...
            >
                <div className="bg-white inline-block px-2 py-1 rounded m-4 text-center text-primary font-poppins">
